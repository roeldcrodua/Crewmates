...
This web app:
The Crewmates Pokémon App is a custom web application that lets users build and manage their own team of Pokémon. Inspired by the idea of assembling unique game characters, the app allows players to select, add, and organize their favorite Pokémon as part of their personalized crew. It uses Supabase for database management and performs CRUD operations through API requests, giving users an interactive and dynamic team-building experience.
